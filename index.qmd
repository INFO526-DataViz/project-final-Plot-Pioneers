...
```{r include=FALSE, message=FALSE, warning=FALSE, results='hide',echo=FALSE}
...
```{r Package loadings, include=FALSE, message=FALSE, warning=FALSE, results='hide'}
library(markdown)
library(DT)
library(ggplot2)
library(dplyr)
...
```{r Data loading, include=FALSE, message=FALSE, warning=FALSE, results='hide'}
...
```{r Scatter Plot, include=FALSE, message=FALSE, warning=FALSE, results='hide'}
...
```{r Trend Time Series Plot, include=FALSE, message=FALSE, warning=FALSE, results='hide'}
